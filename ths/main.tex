...
% Suppress two known load-order warnings caused by elteikthesis.cls loading
% csquotes before minted loads fvextra/lineno.  The silence package filters
% the messages without affecting functionality.
\usepackage{silence}
\WarningFilter{fvextra}{csquotes should be loaded after fvextra}
\WarningFilter{lineno}{Command \@parboxrestore has changed}
